...
export const MOCK_INGESTION_JOBS = [
    {
...
// ============================================================================
export function setupSuccessfulMocks(mockPrisma) {
    // Repository mocks
...
export function setupFailureMocks(mockPrisma) {
...
export function setupRateLimitMocks(mockPrisma) {
    let requestCount = 0;
...
export function createMockQueryResults(options = {}) {
    const { totalTests = 100, passedTests = 80, failedTests = 15, errorTests = 3, skippedTests = 2, averageDuration = 1500, totalDuration = 150000 } = options;
    return {
        aggregate: {
...
export function createMockDatabaseState(mockPrisma) {
