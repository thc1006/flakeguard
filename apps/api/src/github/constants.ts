...
export const CHECK_RUN_ACTION_CONFIGS = {
  quarantine: {
    ...
    identifier: 'quarantine' as CheckRunAction,
    icon: '🔒',
    severity: 'warning',
  ...
  rerun_failed: {
    ...
    identifier: 'rerun_failed' as CheckRunAction,
    icon: '🔄',
    severity: 'info',
  ...
  open_issue: {
    ...
    identifier: 'open_issue' as CheckRunAction,
    icon: '📋',
    severity: 'info',
    requiresConfirmation: false,
  },
  dismiss_flake: {
    ...
    identifier: 'dismiss_flake' as CheckRunAction,
    icon: '✅',
    severity: 'success',
    requiresConfirmation: true,
  },
  mark_stable: {
    ...
    identifier: 'mark_stable' as CheckRunAction,
    icon: '🎯',
    severity: 'success',
    requiresConfirmation: false,
  },
