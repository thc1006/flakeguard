...
class DevelopmentSeeder {
  ...
  async initialize(): Promise<boolean> {
    ...
    try {
      ...
      log('red', `❌ Failed to connect to database: ${(error as any).message}`);
      return false;
    }
  }
  ...
  async seedUsers(): Promise<User[]> {
    ...
    try {
      ...
      log('red', `❌ Failed to seed users: ${(error as any).message}`);
      throw error;
    }
  }
  ...
  async seedProjects(): Promise<Project[]> {
    ...
    try {
      ...
      log('red', `❌ Failed to seed projects: ${(error as any).message}`);
      throw error;
    }
  }

  async seedTestSuites(projects: Project[]): Promise<TestSuite[]> {
    ...
    try {
      ...
      log('red', `❌ Failed to seed test suites: ${(error as any).message}`);
      throw error;
    }
  }

  async seedTestCases(testSuites: TestSuite[]): Promise<TestCase[]> {
    ...
    try {
      ...
      log('red', `❌ Failed to seed test cases: ${(error as any).message}`);
      throw error;
    }
  }

  async seedTestRuns(testCases: TestCase[]): Promise<TestRun[]> {
    ...
    try {
      ...
      log('red', `❌ Failed to seed test runs: ${(error as any).message}`);
      throw error;
    }
  }
  ...
  async cleanup(): Promise<void> {
    try {
      ...
      log('yellow', `⚠️  Error during cleanup: ${(error as any).message}`);
    }
  }
  ...
  async run(): Promise<void> {
    try {
      ...
      log('red', `💥 Seeding failed: ${(error as any).message}`);
